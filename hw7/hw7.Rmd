...
#library(tidyverse)
library(tm)
news<-read.csv("/Users/siyeonlee/Desktop/Data180_SiyeonLee/hw7/news.csv",header=T)
```

Read also the positive and negative word dictionaries, both found on Github. This will later come in handy:

```{r}
posWords <- scan("/Users/siyeonlee/Desktop/Data180_SiyeonLee/hw7/positive-words.txt", character(0), sep = "\n")  # 2006 items
negWords <- scan("/Users/siyeonlee/Desktop/Data180_SiyeonLee/hw7/negative-words.txt", character(0), sep = "\n")  # 4783 items
head(posWords,15)
head(negWords,15)
```
...
#The probability that a given topic appears in a particular document is Gammas
#higher probability documents is showing the main topics
...
top_news %>%
  ...
  scale_y_recordered() #take care of labels
```
